...
export default function LoginPage() {
  ...
  const error = loginMutation.error 
    ...
    ? (googleLoginMutation.error as Error).message || 'Đăng nhập Google thất bại'
    : '';
        ...
        <div className="relative z-10 w-full max-w-[480px] bg-white dark:bg-[#2c2824] rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] p-8 sm:p-12 border border-[#f0f0f0] dark:border-[#3e3a35]">
          ...
          <div className="grid grid-cols-1 gap-4">
            <button
              ...
              className="flex items-center justify-center gap-3 w-full rounded-full border border-border dark:border-[#4a453e] bg-white dark:bg-[#1e1a14] py-3 px-4 text-sm font-semibold hover:bg-gray-50 dark:hover:bg-[#332f29] transition-colors focus:outline-none focus:ring-2 focus:ring-primary/20 disabled:opacity-50 disabled:cursor-not-allowed"
            >
