/**
 * Fashion AI - Trang Đăng Nhập
 * 
 * Form đăng nhập với email/password và Google OAuth
 */
    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold mt-6 mb-2">Đăng nhập</h1>
          <p className="text-secondary">Chào mừng bạn quay trở lại!</p>
        </div>
        ...
        <div className="card p-8">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white dark:bg-[#25221d] text-secondary">Hoặc</span>
            </div>
          </div>
